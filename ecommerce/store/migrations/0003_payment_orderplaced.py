    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Принятый', 'Принятый'), ('Упакован', 'Упакован'), ('В пути', 'В пути'), ('Доставлен', 'Доставлен'), ('Отмена', 'Отмена'), ('В ожидании', 'В ожиданнии')], default='Pending', max_length=50)),
